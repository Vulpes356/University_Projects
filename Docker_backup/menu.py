...
# README.md
# Khi sử dụng option 5 mà before ko hiện gì -> chưa zfs create
# Để kiểm tra các query tốt nhất: xóa hết từ .json (chừa 1 giá trị) và check
# có một số đặc thù trong binlog nên cách bắt lỗi sẽ không phải là duy nhất
...
DATABASE_COMPARATION = "forensics_db"
